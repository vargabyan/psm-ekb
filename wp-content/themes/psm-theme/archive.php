...
<!--                        <div class="card-descr"><span>--><?php //= get_post_meta(get_the_ID(), 'meta1_field_6', true); ?><!--</span>-->
<!--                        </div>-->
<!--                        <a href="--><?php //= get_permalink(); ?><!--">-->
<!--                            <div class="product-description"><span>Подробнее</span></div>-->
<!--                        </a>-->
<!--                        <a data-auto="--><?php //= get_the_title(); ?><!--" data-call="auto" href="javascript:void(0);">-->
...
<!--</div>-->
<!---->
<?php //= do_shortcode('[delivery_rent]') ?>
<!---->
