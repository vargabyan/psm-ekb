            ...
            <div class="col-xs-12 col-md-8 col-lg-7">
                <div class="left-block">
                    ...
                    <div class="box-2">
                        ...
                        <ul>
                            <li>У нас собственный парк автовышек АГП от 15 до 45 метров от 900 руб./час (без учета НДС
                                20%)
                            </li>
                        </ul>
                    </div>
...
<div class="advantages-block width-block">
    ...
    <div class="item-contact">
        <p class="part-1">Если у вас есть вопрос, то звоните нам по номеру <a href="tel:88003017391">8 800 301 73 91</a>
        </p>
        <div>
            <div class="icon-box">
                <div>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="our-truck-crane_item">
                ...
                <div class="info-box">
                    ...
                    <a href="https://psm-ekb96.ru/foto/avtovyshka-dlya-montazha-oborudovaniya-sotovoj-svyazi-tele-2-pos-klyuchi/">ОБЪЕКТ:
                        Свердловская обл, Сысертский район, пос . Ключи , ООО Квазар Урал. Установка столба 40 м и
            ...
            <div class="our-truck-crane_item">
                ...
                <div class="info-box">
                    ...
                    <a href="https://psm-ekb96.ru/foto/aavtovyshka-vezdekhod-dlya-zameny-steklopaketov-g-ekaterinburg-tekhnopark/">ОБЪЕКТ:
                         г. Екатеринбург, ООО Рост-Импульс. В Технопарке наша  вышка 45 м вездеход помогала в замене
            ...
            <div class="our-truck-crane_item">
                ...
                <div class="info-box">
                    ...
                    <a href="https://psm-ekb96.ru/foto/avtovyshka-dlya-klininga-fasada-gu-sberbanka-g-ekaterinburg/">ОБЪЕКТ:
                        г. Екатеринбург, Главное Управление Сбербанка. Работы по клинингу фасада и остекления от здания
                        16 м , высота 43 м.</a>
                </div>
            ...
            <div class="our-truck-crane_item">
                <img loading="lazy" class="alignnone size-medium wp-image-236"
                     ...
                     alt="Аренда автовышки" width="300" height="225"/>
                <div class="info-box">
                    <a href="https://psm-ekb96.ru/foto/avtovyshka-dlya-uteplenie-perekrytiya-g-pervouralsk/">Вид АГП:
                        Автовышка 40 м</a>
                    <a href="https://psm-ekb96.ru/foto/avtovyshka-dlya-uteplenie-perekrytiya-g-pervouralsk/">ОБЪЕКТ: г.
                        Первоуральск, ООО АС-Логистик. Утепление перекрытия по фасаду жилого дома. Расстояние от здания
                        15 м, высота 30 м.</a>
                </div>
...
<div class="block-for-our-clients">
    ...
    <div class="right-box">
        <div><img class="our-client_item_img" loading="lazy" src="/wp-content/uploads/2019/10/mesto.jpg" alt="logo"/>
        </div>
        <div><img class="our-client_item_img" loading="lazy" src="/wp-content/uploads/2019/10/megafon.jpg" alt="logo"/>
        </div>
...
<div class="contacts-block width-block">
    ...
    <div class="right-box">
        ...
        <div class="link-box">
            <a href="/watch-on-the-map">Посмотреть нас на карте</a>
            <svg width="41" height="8" viewBox="0 0 41 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M40.8536 4.35355C41.0488 4.15829 41.0488 3.84171 40.8536 3.64645L37.6716 0.464466C37.4763 0.269204 37.1597 0.269204 36.9645 0.464466C36.7692 0.659728 36.7692 0.976311 36.9645 1.17157L39.7929 4L36.9645 6.82843C36.7692 7.02369 36.7692 7.34027 36.9645 7.53553C37.1597 7.7308 37.4763 7.7308 37.6716 7.53553L40.8536 4.35355ZM0 4.5H40.5V3.5H0V4.5Z" fill="black"/>
            </svg>
        </div>
            ...
            <div>
                ...
                <div class="whatsapp-box">
                    <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.3 26C6.5 25.5 2.6 28.4 2 27.7C1.4 27.1 4 23 3.5 22.3C1.9 20.1 1 17.4 1 14.5C1 7.1 7 1 14.5 1C22 1 28 7.1 28 14.5C28 21.9 22 28 14.5 28C13.5 28 12.6 27.9 11.7 27.7" stroke="white" stroke-width="1.25" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M11.7 7.70008L12.9 10.7001C13 10.9001 12.9 11.1001 12.7 11.2001C12.2 11.5001 11.5 12.2001 12.3 13.3001C13.3 14.7001 16 18.2001 18.2 15.9001C18.3 15.8001 18.5 15.7001 18.7 15.8001L21.9 17.2001C22.1 17.3001 22.2 17.6001 22.1 17.8001C21.4 19.2001 18.7 22.9001 12 17.1001C5.2 11.2001 9.6 8.30008 11.1 7.60008C11.3 7.30008 11.6 7.40008 11.7 7.70008Z" stroke="white" stroke-width="1.25" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
                <div class="telegram-box">
                    <svg width="29" height="26" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.10093 11.6C7.90093 9 27.5009 1 27.5009 1L23.6009 23.6C23.4009 24.7 22.1009 25.1 21.3009 24.4L15.2009 19.3L10.9009 23.3L11.6009 16.6L24.6009 4.3L8.60093 14.3L9.60093 20L6.30093 14.7L1.30093 13.1C0.500925 12.8 0.400925 11.8 1.10093 11.6Z" stroke="white" stroke-width="1.25" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
            </div>
