...
<div class="maxWidth_1110px">
    ...
    <div class="name-container">
        ...
        <div class="name-container__content">
...
<div class="product-data-container">
    ...
    <div class="product-data-container__content">
        <div class="right_box">
            <button class="js_features">Характеристики</button>
            <button class="js_description">Описание</button>
            <button class="js_payment_delivery">Оплата и доставка</button>
        </div>
        <div class="line_item"></div>
        <div class="left_box">
...
<!--<div class="block_container__2_mobil">-->
<!---->
<!--        <div class="features_box_mobil">-->
<!--            <button class="js_features_mobil">-->
<!--                Характеристики-->
<!--                <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">-->
<!--                    <path d="M1.175 6L5 2.2915L8.825 6L10 4.8583L5 0L0 4.8583L1.175 6Z" fill="#3B8AF0"/>-->
<!--                </svg>-->
<!--            </button>-->
<!--            <div>-->
<!--                --><?php //=get_post_meta($post->ID, 'meta1_field_8', true);?>
<!--            </div>-->
<!--        </div>-->
<!--        <div class="description_box_mobil">-->
<!--            <button class="js_description_mobil">-->
<!--                Описание-->
<!--                <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">-->
<!--                    <path d="M1.175 6L5 2.2915L8.825 6L10 4.8583L5 0L0 4.8583L1.175 6Z" fill="#3B8AF0"/>-->
<!--                </svg>-->
<!--            </button>-->
<!--            <div>-->
<!--                --><?php //=get_post_meta($post->ID, 'meta1_field_6', true);?>
<!--            </div>-->
<!--        </div>-->
<!--        <div class="payment_delivery_box_mobil">-->
<!--            <button class="js_payment_delivery_mobil">-->
<!--                Оплата и доставка-->
<!--                <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">-->
<!--                    <path d="M1.175 6L5 2.2915L8.825 6L10 4.8583L5 0L0 4.8583L1.175 6Z" fill="#3B8AF0"/>-->
<!--                </svg>-->
<!--            </button>-->
<!--            <div>-->
<!--                --><?php //=get_post_meta($post->ID, 'meta1_field_7', true);?>
<!--            </div>-->
<!--        </div>-->
<!---->
<!--</div>-->
